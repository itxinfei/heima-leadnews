...
export const  API_ARTICLES_UPDOWN = '/api/v1/media/news/down_or_up' //上下架
export const  API_ARTICLES_DELETE = '/api/v1/media/news/del_news' //删除文章API_MODIFYIMAGE_DELETE
